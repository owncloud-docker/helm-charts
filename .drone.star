    ...
    return [{
        ...
        "steps": [
            ...
            },
            {
                ...
                "commands": [
                    "sed -i 's/version: 0.0.0-devel/version: %s/g' charts/owncloud/Chart.yaml" % (ctx.build.ref.replace("refs/tags/", "").removeprefix("v") if ctx.build.event == "tag" else "v0.0.0-devel"),
