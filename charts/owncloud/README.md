...
| owncloud.mail.smtp | object | `{"auth":"","authType":"","debug":"","host":"","mode":"","name":"","password":"","port":"","secure":"","timeout":""}` | Define the SMTP authentication (see [documentation](https://doc.owncloud.com/server/latest/admin_manual/configuration/server/config_sample_php_parameters.html#define-the-smtp-authentication)). |
...
| owncloud.rememberLoginCookieLifetime | string | `""` |  |
...
| owncloud.trustedProxies | string | `""` |  |
